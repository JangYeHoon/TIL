...
5. [CPU Scheduling](#5-cpu-scheduling)
   ...
   - [Scheduling Criteria](#scheduling-criteria)
     ...
     - [SJF(Shortest Job First) Scheduling](#sjfshortest-job-first-scheduling)
     - [SRF(Shortest Remaining Time First Scheduling)](#srfshortest-remaing-time-first-scheduling)
     - [Priority Scheduling](#priority-scheduling)
     - [RR(Round Robin) Scheduling](#rrround-robin-scheduling)
   ...
   - [Real-Time CPU Scheduling](#real-time-cpu-scheduling)
     ...
     - [Earliest Deadline First Scheduling(EDF)](#earliest-deadline-first-schedulingedf)
